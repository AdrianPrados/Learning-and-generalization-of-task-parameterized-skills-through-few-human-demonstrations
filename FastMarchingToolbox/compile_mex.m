% compile mex file
mex FastMarchingToolbox/mex/perform_front_propagation_2d.cpp FastMarchingToolbox/mex/perform_front_propagation_2d_mex.cpp FastMarchingToolbox/mex/fheap/fib.cpp 
mex FastMarchingToolbox/mex/perform_front_propagation_3d.cpp FastMarchingToolbox/mex/perform_front_propagation_3d_mex.cpp  FastMarchingToolbox/mex/fheap/fib.cpp 
mex FastMarchingToolbox/mex/perform_circular_front_propagation_2d.cpp FastMarchingToolbox/mex/perform_front_propagation_2d.cpp FastMarchingToolbox/mex/fheap/fib.cpp 
...
% compiling skeleton
mex FastMarchingToolbox/mex/skeleton.cpp
% compiling distance transform
mex FastMarchingToolbox/mex/eucdist2.c

disp('Compiling perform_front_propagation_mesh, might time some time.');
rep = 'FastMarchingToolbox/mex/';
files =  { ...
